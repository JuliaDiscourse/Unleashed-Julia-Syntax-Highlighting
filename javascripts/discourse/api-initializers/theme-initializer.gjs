...
function julia(hljs) {
  ...
  var TYPE_CONTEXT = {
    ...
    variants: [
      ...
      {
        begin: VARIABLE_NAME_RE + "(?=\\." + VARIABLE_NAME_RE + "{)",
        end: "}",
      },
      // Match Union{...}
    ...
    contains: [BUILTIN_OPERATORS, KEYWORDLIKE_OPERATORS, "self"],
  };
  ...
  var ATOMS = [NUMBER, CHAR, STRING_REGEX_CMD, SYMBOL, MACROCALL];
  ...
  var FUNCTION_DEFINITION = {
    ...
    contains: [
      ...
      {
        begin: "(" + VARIABLE_NAME_RE + ")(?=\\.)",
        end: "(?=" + VARIABLE_NAME_RE + "({.*?})?\\()",
        contains: [{ begin: "\\.", className: "built_in" }],
      },
      // Function name
  ...
  var TYPEDEF = {
    ...
    variants: [
      ...
      {
        begin:
          "(?<=abstract[ \\t]+type[ \\t]+)" + VARIABLE_NAME_RE + "({.*?})?",
      },
      {
        begin:
          "(?<=(mutable[ \\t]+)?struct[ \\t]+)" + VARIABLE_NAME_RE + "({.*?})?",
      },
    ],
  };
